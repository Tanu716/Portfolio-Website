					...
					<div className=
						...
						<div className="qualification_data">
							<div>
								...
								<span className="qualification__subtitle">G.H.Mahajan Highschool</span>
						...
						<div className="qualification_data">
							...
							<div>
								...
								<span className="qualification__subtitle">Nemsushil Jr College</span>
								<div className="qualification_calendar">
									<i className="uil uil-calendar-alt"></i>
									2017-2019
								</div>
						...
						<div className="qualification_data">
							<div>
								<h3 className="qualification__title">C, CPP, C# </h3>
